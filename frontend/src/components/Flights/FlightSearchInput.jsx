...
function FlightSearchInput({trip , setTrip ,numberOfPassengers , setNumberOfPassengers , from , setFrom , to , setTo , departureDate , setDepartureDate , returnDate , setReturnDate , isLoading , handleSearch }) {
  return (
    <div className='flex flex-col  p-5 bg-white m-5 border rounded-3xl '>
      <div className='flex'>
        ...
        <Select label='Number of passengers' className='max-w-xs ' variant='bordered' size='sm' value={numberOfPassengers} onChange={(e)=> setNumberOfPassengers(e.target.value)}>
