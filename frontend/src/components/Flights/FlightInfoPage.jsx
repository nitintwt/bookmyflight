          ...
          <div className="grid gap-6">
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-white">
                  Flight {flightInfo?.itineraries?.[0]?.segments?.[0]?.number}{' '}
                </p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-4 text-white">
              <div className="grid gap-1">
                ...
                <div className="text-lg font-bold">
                  {
                    flightInfo?.travelerPricings?.[0]?.fareDetailsBySegment?.[0]
                      ?.cabin
                  }
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-white">
              ...
              <div className="grid gap-1">
                ...
                <div className="text-lg font-bold">
                  {flightInfo?.itineraries?.[0]?.segments?.length - 1}
                </div>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-4 text-white">
              <div className="grid gap-1">
                ...
                <div className="text-lg font-bold">
                  {formatTiming(
                    flightInfo?.itineraries?.[0]?.segments?.[0]?.departure?.at
                  )}
                </div>
              </div>
              <div className="grid gap-1">
                ...
                <div className="text-lg font-bold">
                  {formatTiming(
                    flightInfo?.itineraries?.[0]?.segments[
                      flightInfo?.itineraries?.[0]?.segments.length - 1
                    ]?.arrival?.at
                  )}
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-white">
              <div className="grid gap-1">
                ...
                <div className="text-lg font-bold">
                  {flightInfo?.travelerPricings?.[0]?.fareDetailsBySegment?.[0]
                    ?.amenities?.[2]?.isChargeable === false
                    ? 'Included'
                    : 'Not Included'}
                </div>
              </div>
              ...
              <CardBody className="grid gap-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="grid gap-1">
                    ...
                    <div className="text-lg font-bold">
                      {
                        flightInfo?.itineraries?.[0]?.segments?.[0]?.departure
                          ?.iataCode
                      }
                    </div>
                  </div>
                    ...
                    <div className="text-lg font-bold">
                      ...
                      0 ? (
                        <p>
                          At{' '}
                          {
                            flightInfo?.itineraries?.[0]?.segments?.[0]?.arrival
                              ?.iataCode
                          }{' '}
                          from{' '}
                          {formatTiming(
                          ...
                          to{' '}
                          {formatTiming(
                            flightInfo?.itineraries?.[0]?.segments?.[1]
                              ?.departure?.at
                          )}
                        </p>
                      ) : (
                      ...
                      1 ? (
                        <p>
                          At{' '}
                          {
                            flightInfo?.itineraries?.[0]?.segments?.[1]?.arrival
                              ?.iataCode
                          }{' '}
                          from{' '}
                          {formatTiming(
                          ...
                          to{' '}
                          {formatTiming(
                            flightInfo?.itineraries?.[0]?.segments?.[2]
                              ?.departure?.at
                          )}
                        </p>
                      ) : (
                      ...
                      2 ? (
                        <p>
                          At{' '}
                          {
                            flightInfo?.itineraries?.[0]?.segments?.[2]?.arrival
                              ?.iataCode
                          }{' '}
                          from{' '}
                          {formatTiming(
                          ...
                          to{' '}
                          {formatTiming(
                            flightInfo?.itineraries?.[0]?.segments?.[3]
                              ?.departure?.at
                          )}
                        </p>
                      ) : (
